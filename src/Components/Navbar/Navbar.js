        ...
        <nav className='navbar'>
          ...
          <List className='navbar__nav' id='nav'>
            <ListItem className='icon' id='navbar__hamburger'>
              <i onClick={this.onClick} className='fa fa-bars'></i>
            </ListItem>
            <ListItem className='navbar__list_item' href='#about'>
              About
            </ListItem>
            <ListItem className='navbar__list_item' href='#skills'>
              Skills
            </ListItem>
            <ListItem className='navbar__list_item' href='#portfolio'>
              Portfolio
            </ListItem>
            <ListItem className='navbar__list_item' href='#contact'>
              Contact
            </ListItem>
          </List>
        </nav>
